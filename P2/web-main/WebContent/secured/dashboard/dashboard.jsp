...
<html>
	...
	<body>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12 sub_menu">
							<ul id="dsh_grp_ul" class="nav-tabs nav-tabs_ul">
							</ul>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12 sub_menu sub_sub_menu">
							<ul id="dsh_sub_grp_ul" class="nav-tabs nav-tabs_ul">
							</ul>
						</div>
					</div>
					<!---------------------------------------------->
					<div class="chartsheetDiv">
						<div class="row">
							...
							<!-- ******************* -->
							<div class=" col-md-7 col-sm-7 col-xs-12 div_chrt">
	    ...
	    <script type="text/javascript" src="<%=getServletContext().getContextPath() %>/secured/dashboard/script/dashboard.js"></script>
	</body>
</html>