...
<html>
	<head>
	    ...
	    <script src="<%=getServletContext().getContextPath() %>/js/bootbox.js"></script>
			...
			<%
				try {
					if (request.getSession().getAttribute("user_code") == null){
						...
						if(datas.size() == 0) {
							response.sendRedirect("../../messages.jsp?type='no_user'");
							return;
						} else {
							...
							request.getSession().setAttribute("user_gp", datas.get(0)[7]); //# 18.01.2022
						}
					} 
			...
			%>
<style type="text/css">
	#div_children #div_outer #div_0004{
	position:relative;
}
#div_children #div_outer #div_0004:after{
	position:absolute;
	content:'No. of Children as per HH Listing';
	left:0;
	right:0;
	top:0;
	width:100%;
...
#div_children #div_outer #div_0005{
	position:relative;
}
#div_children #div_outer #div_0005:after{
	position:absolute;
	content:'Total Enrolment in Creche';
	left:0;
	right:0;
	top:0;
	width:100%;
...
#div_children #div_outer #div_0006{
	position:relative;
}
#div_children #div_outer #div_0006:after{
	position:absolute;
	content:'Current Level of Enrolment in Creches (Total Enrolment minus Graduated Children)';
	left:0;
	right:0;
	top:0;
	width:100%;
	...
	<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div id="div_filter_details" class="filter_details">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12 sub_menu">
							<ul id="ovr_sub_grp_ul" class="nav-tabs nav-tabs_ul"></ul>
						</div>
					</div>
					...
					<div class="overviewDiv">
						...
						<div class="chartsheetDiv">
							<div class="row">
								<div class="col-sm-2 col-xs-12 sel_lbl ">
									<div class="row">
										<!-- <div class="col-sm-12 sel_txt">
								...
								<div id="div_chart" class="col-sm-10 col-xs-12 div_chrt">
									<!-- Functional Creches -->
										<div id="div_functional" class="showChartDiv_fc"></div>
									
									<!-- Children in Creches -->
										<div id="div_children" class="showChartDiv_cic" style="display:none;"></div>
									
									<!-- One Time Child Anthro -->
										<div id="div_anthro" class="showChartDiv_ca" style="display:none;"></div>
									
									<!-- Monthly Status -->
										<div id="div_monthly" class="showChartDiv_ms" style="display:none;"></div>				
								</div>
	    ...
	    <script type="text/javascript" src="<%=getServletContext().getContextPath() %>/secured/overview/script/overview.js"></script>
