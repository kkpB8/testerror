...
/**
 * Servlet implementation class Quality NRC Follow Up Sync
 */
public class NRCFollowUpSync extends HttpServlet {
	/**
	 ...
	 * Write log
	 */
	private static Log log = LogFactory.getLog(NRCFollowUpSync.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<String[]> lst_data = DataFetcher.getProcData("CALL sp_df_child_nrc_followup_pd("+Utility.checkVal(str_imei)+", "+Utility.checkVal(str_user_name)+")");
			...
			log.info("Error to get NRC Follow Up Sync Data for Mobile..."+e.getLocalizedMessage());
