...
/**
 * Servlet implementation class Child Immunization Sync
 */
public class ChildImmunizationSync extends HttpServlet {
	/**
	 ...
	 * Write log
	 */
	private static Log log = LogFactory.getLog(ChildImmunizationSync.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<String[]> lst_data = DataFetcher.getProcData("CALL sp_df_child_immu_pd("+Utility.checkVal(str_imei)+", "+Utility.checkVal(str_user_name)+")");
			...
			log.info("Error to get Child Immunization Sync Data for Mobile..."+e.getLocalizedMessage());
