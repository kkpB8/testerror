...
/**
 * Servlet implementation class Attendance Sync
 */
public class AttendanceSync extends HttpServlet {
	/**
	 ...
	 * Write log
	 */
	private static Log log = LogFactory.getLog(AttendanceSync.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<String[]> lst_data = DataFetcher.getProcData("CALL sp_df_child_mnth_attend_pd("+Utility.checkVal(str_imei)+", "+Utility.checkVal(str_user_name)+")");
			...
			log.info("Error to get Attendance Data for Mobile..."+e.getLocalizedMessage());
