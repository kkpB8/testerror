...
/**
 * Servlet implementation class Data Edit Notification
 */
public class DataEditNotification extends HttpServlet {
	/**
	 ...
	 * Write log
	 */
	private static Log log = LogFactory.getLog(DataEditNotification.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[][] datas = null;
		try {
			//Processing Data Edit Notification for Mobile
			List<String[]> lst_data = DataFetcher.getProcData("CALL sp_df_mob_noti_rejct("+Utility.checkVal(user_name)+")");
			...
			log.info("Error to get Data Edit Notification for Mobile..."+e.getLocalizedMessage());
