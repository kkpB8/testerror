...
/**
 * Servlet implementation class Creche Monitoring Checklist Form 2 Sync
 */
public class CrecheMonitoringChecklistForm2Sync extends HttpServlet {
	/**
	 ...
	 * Write log
	 */
	private static Log log = LogFactory.getLog(CrecheMonitoringChecklistForm2Sync.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<String[]> lst_data = DataFetcher.getProcData("CALL sp_df_creche_monitor_chkliist_brief_pd("+Utility.checkVal(str_imei)+", "+Utility.checkVal(str_user_name)+")");
			...
			log.info("Error to get Creche Monitoring Checklist Sync Data for Mobile..."+e.getLocalizedMessage());
