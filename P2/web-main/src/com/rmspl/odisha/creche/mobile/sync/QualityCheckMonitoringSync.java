...
/**
 * Servlet implementation class Quality Check Montoring Sync
 */
public class QualityCheckMonitoringSync extends HttpServlet {
	/**
	 ...
	 * Write log
	 */
	private static Log log = LogFactory.getLog(QualityCheckMonitoringSync.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<String[]> lst_data = DataFetcher.getProcData("CALL sp_df_qlty_chk_monitor_pd("+Utility.checkVal(str_imei)+", "+Utility.checkVal(str_user_name)+")");
			...
			log.info("Error to get Quality Check Montoring Data for Mobile..."+e.getLocalizedMessage());
