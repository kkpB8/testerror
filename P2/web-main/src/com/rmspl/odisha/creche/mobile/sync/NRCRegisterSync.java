...
/**
 * Servlet implementation class Quality NRC Register Sync
 */
public class NRCRegisterSync extends HttpServlet {
	/**
	 ...
	 * Write log
	 */
	private static Log log = LogFactory.getLog(NRCRegisterSync.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<String[]> lst_data = DataFetcher.getProcData("CALL sp_df_child_nrc_reg_pd("+Utility.checkVal(str_imei)+", "+Utility.checkVal(str_user_name)+")");
			...
			log.info("Error to get NRC Register Sync Data for Mobile..."+e.getLocalizedMessage());
