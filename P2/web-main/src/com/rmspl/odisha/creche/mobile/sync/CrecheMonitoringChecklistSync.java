...
/**
 * Servlet implementation class Creche Monitoring Checklist Sync
 */
public class CrecheMonitoringChecklistSync extends HttpServlet {
	/**
	 ...
	 * Write log
	 */
	private static Log log = LogFactory.getLog(CrecheMonitoringChecklistSync.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<String[]> lst_data = DataFetcher.getProcData("CALL sp_df_creche_monitor_chkliist_pd("+Utility.checkVal(str_imei)+", "+Utility.checkVal(str_user_name)+")");
