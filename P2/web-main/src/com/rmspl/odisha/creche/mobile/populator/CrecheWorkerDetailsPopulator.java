...
/**
 * Servlet implementation class Creche Worker Details Populator
 */
public class CrecheWorkerDetailsPopulator extends HttpServlet {
	/**
	 ...
	 * Write log
	 */
	private static Log log = LogFactory.getLog(CrecheWorkerDetailsPopulator.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[][] datas = null;
		try {
			//Processing GP, Village, Creche, Creche Type, Creche Worker Master Data for Mobile
			List<String[]> lst_data = DataFetcher.getProcData("CALL sp_df_cr_wrk_pop("+Utility.checkVal(user_name)+")");
