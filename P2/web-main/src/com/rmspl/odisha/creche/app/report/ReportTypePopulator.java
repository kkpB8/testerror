 ...
 */
public class ReportTypePopulator extends HttpServlet {
	...
	private static Log log = LogFactory.getLog(ReportTypePopulator.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String[][] datas = null;
		try {
			List<String[]> lstdata = DataFetcher.getProcData("CALL sp_df_hp_webrept_lvl_pop()");
