 ...
 */
public class MonitoringIndicatorPopulator extends HttpServlet {
	...
	private static Log log = LogFactory.getLog(MonitoringIndicatorPopulator.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String[][] datas = null;
		try {
			List<String[]> lstdata = DataFetcher.getProcData("CALL sp_df_hp_monitor_indi_pop('"+
																request.getParameter("sel_fltr_level")+"', '"+
																request.getParameter("sel_mtr_grp")+"', '"+
																request.getParameter("sel_mtr_sub_grp")+"')");
