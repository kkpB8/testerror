 ...
 */
public class DashboardGroupPopulator extends HttpServlet {
	...
	private static Log log = LogFactory.getLog(DashboardGroupPopulator.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String[][] datas = null;
		try {
			List<String[]> lstdata = DataFetcher.getProcData("CALL sp_df_hp_dashboard_catg_pop('"+request.getParameter("type")+"')");
