 ...
 */
public class MonitoringGroupPopulator extends HttpServlet {
	...
	private static Log log = LogFactory.getLog(MonitoringGroupPopulator.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String[][] datas = null;
		try {
			List<String[]> lstdata = DataFetcher.getProcData("CALL sp_df_hp_monitor_catg_pop('"+request.getParameter("type")+"')");
