 ...
 */
public class EditApprovePendSummryAll extends HttpServlet {
	private static final long serialVersionUID = 1L;
	/**
	 * Write Log
	 */
	private static Log log = LogFactory.getLog(EditApprovePendSummryAll.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			String sel_yr = request.getParameter("sel_yr");
			
			String str_sql = "CALL sp_df_data_edit_tbl("+Utility.checkVal(sel_yr)+")";
