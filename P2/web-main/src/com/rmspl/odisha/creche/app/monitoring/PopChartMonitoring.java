package com.rmspl.odisha.creche.app.monitoring;
 ...
 */
public class PopChartMonitoring extends HttpServlet {
	private static final long serialVersionUID = 1L;
	/**
	 * Write Log
	 */
	private static Log log = LogFactory.getLog(PopChartMonitoring.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			/*String str_sql = "CALL sp_df_hp_monitor_pop("+Utility.checkVal(filter_level)+", "+
			...
			//For Total
			//1,5,9,13,17
			if(sub_grp_code.equalsIgnoreCase("1")
					|| sub_grp_code.equalsIgnoreCase("5")
						|| sub_grp_code.equalsIgnoreCase("9")
							|| sub_grp_code.equalsIgnoreCase("13")
								|| sub_grp_code.equalsIgnoreCase("17")) {
				...
				if(sel_creche_catg.equalsIgnoreCase("All")){
					...
					str_sql = "CALL sp_df_hp_monitor_pop_total_cr("+Utility.checkVal(filter_level)+", "+
															   		Utility.checkVal(filter_code)+", "+
															   		Utility.checkVal(sub_grp_code)+", "+
															   		Utility.checkVal(indi_code)+", "+
															   		Utility.checkVal(sel_mnth_yr)+", "+
			...
			//For By Sex
			else if(sub_grp_code.equalsIgnoreCase("2")
						|| sub_grp_code.equalsIgnoreCase("6")
							|| sub_grp_code.equalsIgnoreCase("10")
								|| sub_grp_code.equalsIgnoreCase("14")
									|| sub_grp_code.equalsIgnoreCase("18")) {
			...
			//For By Religion
			else if(sub_grp_code.equalsIgnoreCase("3")
					|| sub_grp_code.equalsIgnoreCase("7")
						|| sub_grp_code.equalsIgnoreCase("11")
							|| sub_grp_code.equalsIgnoreCase("15")
								|| sub_grp_code.equalsIgnoreCase("19")) {
			...
			//For By Caste
			else if(sub_grp_code.equalsIgnoreCase("4")
					|| sub_grp_code.equalsIgnoreCase("8")
						|| sub_grp_code.equalsIgnoreCase("12")
							|| sub_grp_code.equalsIgnoreCase("16")
								|| sub_grp_code.equalsIgnoreCase("20")) {
