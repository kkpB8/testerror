...
/**
 * Servlet implementation to populate indicator for Overview
 */
public class OverviewIndicatorPopulator extends HttpServlet {
	...
	private static Log log = LogFactory.getLog(OverviewIndicatorPopulator.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String[][] datas = null;
		try {
			List<String[]> lstdata = DataFetcher.getProcData("CALL sp_df_hp_ovrview_indi_pop('"+
																request.getParameter("sel_fltr_level")+"', '"+
																request.getParameter("sel_ovr_sub_grp")+"')");
