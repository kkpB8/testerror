 ...
 */
public class StDtBkGpVlCrFormPopulator extends HttpServlet {
	...
	private static Log log = LogFactory.getLog(StDtBkGpVlCrFormPopulator.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String[][] datas = null;
		try {
			List<String[]> lstdata = DataFetcher.getProcData("CALL sp_df_form_edit_manage_pop("+
																Utility.checkVal(request.getRemoteUser())+", "+
																Utility.checkVal(request.getParameter("form_type"))+
																")");
