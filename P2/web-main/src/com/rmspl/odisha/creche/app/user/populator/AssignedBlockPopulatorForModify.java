...
public class AssignedBlockPopulatorForModify extends HttpServlet {
	/**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			lstdata = DataFetcher.getProcData("CALL sp_df_tab_usr_bk_pop("+											
											    Utility.checkVal(request.getParameter("user_code"))+
												")");
			if(lstdata.size() == 0) {
