 ...
 */
public class EditApprovedSummryAll extends HttpServlet {
	private static final long serialVersionUID = 1L;
	/**
	 * Write Log
	 */
	private static Log log = LogFactory.getLog(EditApprovedSummryAll.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			String str_sql = "CALL sp_df_data_edit_hist_tbl("+Utility.checkVal(sel_yr)+")";
