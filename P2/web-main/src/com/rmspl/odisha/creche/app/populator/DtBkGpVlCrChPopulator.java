...
/**
 * Servlet implementation for populate all the District-Block-Creche
 */

public class DtBkGpVlCrChPopulator extends HttpServlet {
	/**
	 * version identifier for a Serializable class
	 */
	private static final long serialVersionUID = 1L;
	
	private static Log log = LogFactory.getLog(DtBkGpVlCrChPopulator.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			lst_data = DataFetcher.getProcData("CALL sp_df_child_geo_pop()");
