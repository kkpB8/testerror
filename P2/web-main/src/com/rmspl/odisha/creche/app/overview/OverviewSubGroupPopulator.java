...
/**
 * Servlet implementation to populate sub-group for Overview
 */
public class OverviewSubGroupPopulator extends HttpServlet {
	...
	private static Log log = LogFactory.getLog(OverviewSubGroupPopulator.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String[][] datas = null;
		try {
			List<String[]> lstdata = DataFetcher.getProcData("CALL sp_df_hp_ovrview_sub_lvl_pop('"+request.getParameter("type")+"')");
