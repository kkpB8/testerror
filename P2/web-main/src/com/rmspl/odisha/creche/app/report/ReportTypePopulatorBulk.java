...
/**
 * Servlet implementation to populate Report Type for Report
 */
public class ReportTypePopulatorBulk extends HttpServlet {
	...
	private static Log log = LogFactory.getLog(ReportTypePopulatorBulk.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String[][] datas = null;
		try {
			List<String[]> lstdata = DataFetcher.getProcData("CALL sp_df_bulk_rept_pop()");
